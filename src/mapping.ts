...
import { ftmmusd, CreateVault, DestroyVault, TransferVault, DepositCollateral, WithdrawCollateral, BorrowToken, PayBackToken } from '../generated/ftmmusd/ftmmusd'
...
//   let contract = ftmmusd.bind(event.address)
